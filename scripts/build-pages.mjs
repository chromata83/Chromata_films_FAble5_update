...
pages["the-studio.html"] = shell({
  ...
  <!-- GASP scroll-scrubbed film band between the blockbusters and "beyond the frame";
       pins once it reaches mid-screen and holds there while the whole clip scrubs.
       Desktop: 2.39:1 cinemascope. Phones: square, filling the screen width. -->
  <section class="film film--band film--scope vignette" data-scrub data-pin-start="center center" data-pin="+=350%" data-pin-mobile="+=260%" data-theme="dark" data-section aria-label="Chromata Films — cinematic film">
