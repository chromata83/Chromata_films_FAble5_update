...
pages["the-studio.html"] = shell({
  ...
  <!-- GASP scroll-scrubbed film band between the blockbusters and "beyond the frame".
       Desktop: 2.39:1 cinemascope, pins once it reaches mid-screen and holds there
       while the whole clip scrubs. Phones: square, unpinned, stays in flow. -->
  <section class="film film--band film--scope vignette" data-scrub data-pin-start="center center" data-pin="+=350%" data-film-nopin-mobile data-theme="dark" data-section aria-label="Chromata Films — cinematic film">
